...
datasets=(
    # /EmbeddingRun2017B/MuTauFinalState-inputDoubleMu_94X_miniAOD-v2/USER
    /EmbeddingRun2017C/MuTauFinalState-inputDoubleMu_94X_miniAOD-v2/USER
    /EmbeddingRun2017D/MuTauFinalState-inputDoubleMu_94X_miniAOD-v2/USER
    /EmbeddingRun2017E/MuTauFinalState-inputDoubleMu_94X_miniAOD-v2/USER
    /EmbeddingRun2017F/MuTauFinalState-inputDoubleMu_94X_miniAOD-v2/USER
)
...
for sampleName in "${datasets[@]}"; do
	...
	$PWD/run_102X_embedded-data2017-farmout.py
