...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        'file:/hdfs/store/user/ekoenig/TestFiles/TauEmbedding_MuTau_data_Run2017B_merged_248.root' # /EmbeddingRun2017B/MuTauFinalState-inputDoubleMu_94X_miniAOD-v2/USER
        # 'root://cms-xrd-global.cern.ch//store/data/Run2017B/Tau/MINIAOD/31Mar2018-v1/90000/FECFEF99-4F37-E811-8243-001E67792562.root'
    )
)
...
process.phoJetNtuplizer.triggerResults = cms.InputTag("TriggerResults","","SIMembedding")
process.phoJetNtuplizer.recoTriggerResults = cms.InputTag("TriggerResults","","SIMembedding")
